	...
	* @返回$array 内容页重新组装的数组*/
	public function Lable_Vod_Play($array,$array_play,$createplayone){
		...
		if($createplayone){
			...
			$array['vod_player'] = '<script charset="utf-8" src="'.$player_jsdir.'"></script><script charset="utf-8" src="'.C('site_path').'Runtime/Player/play.js"></script><script charset="utf-8" src="'.C('site_path').'Public/player2.8/play.js"></script>'."\n";
		}else{
			$array['vod_player'] = '<script language="javascript">'.$array['vod_player'].'</script><script charset="utf-8" src="'.C('site_path').'Runtime/Player/play.js"></script><script charset="utf-8" src="'.C('site_path').'Public/player2.8/play.js?"></script>'."\n";
		}
		//点击数调用
